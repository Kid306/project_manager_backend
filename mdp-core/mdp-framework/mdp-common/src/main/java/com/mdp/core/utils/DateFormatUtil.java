...
public class DateFormatUtil {
    ...
    public static final String DATE_REGEX_LONGTIME = "^[0-9]{1,}$";//longtime 毫秒
    ...
    public static final String PATTERN_ISO_ON_SECONDZZ = "yyyy-MM-dd'T'HH:mm:ssZZ";
    ...
    public static final FastDateFormat ISO_ON_SECONDZZ_FORMAT = FastDateFormat.getInstance(PATTERN_ISO_ON_SECONDZZ);
    ...
    public static Date pareDate(String dateString) throws ParseException {
        ...
        if (ObjectTools.isNotEmpty(source)) {
            if(source.matches(DATE_REGEX_YYYYMM)){
                ...
                return ISO_ON_SECONDZZ_FORMAT.parse(source);
            ...
            }else if(source.matches(DATE_REGEX_LONGTIME)){
