...
public class StrUtils {
    ...
    public static List<String> splitToString(String value,CharSequence separator){
      return Arrays.asList(value.split((String) separator));
    }
    public static Set<String> splitToStringSet(String value) {
        return Arrays.asList(value.split(StrPool.COMMA)).stream().collect(Collectors.toSet());
    }
