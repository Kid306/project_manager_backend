	...
	<body class="no-skin">
		...
		<div class="main-container" id="main-container">
					<div class="page-header">
						<h4>
							${largeModulePath}${smallModulePathExt}/${tableRemarks}
							<small>
						...
						<div class="col-sm-12">
							...
							<form id="entityForm"  class="form-horizontal" role="form">
								...
								<#if column.simpleJavaClassName=='String'> 
										<input type="text"  id="${column.camelsColumnName}" name="${column.camelsColumnName}" value="${r'${data.'}${column.camelsColumnName}${r'}'}"   maxlength=${column.columnSize}  class="col-xs-10 col-sm-10" />
		...
		$(document).ready(function() {
		 	var validator = $("#entityForm").validate({
				 submitHandler: function(form) {  //通过之后回调 
				     ...
				     $.ajax({ 
						url : "${baseRequestUri}${smallModulePathExt}/${smallEntityName}/insert${entityName}.json", 
						type : "post", 
						dataType : "json", 
						data: param, 
