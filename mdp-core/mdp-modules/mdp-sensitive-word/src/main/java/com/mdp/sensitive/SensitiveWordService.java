...
public class SensitiveWordService {
     ...
     * 敏感词匹配规则
     */
    public final int MinMatchTYpe = 1;      //最小匹配规则，如：敏感词库["中国","中国人"]，语句："我是中国人"，匹配结果：我是[中国]人
    public final int MaxMatchType = 2;      //最大匹配规则，如：敏感词库["中国","中国人"]，语句："我是中国人"，匹配结果：我是[中国人]
    ...
    public void main(String[] args) {
        ...
        //初始化敏感词库
        sensitiveWordService.init(sensitiveWordSet);
 
        System.out.println("敏感词的数量：" + sensitiveWordService.sensitiveWordMap.size());
        ...
        //是否含有关键字
        boolean result = sensitiveWordService.contains(string);
        System.out.println(result);
        result = sensitiveWordService.contains(string, sensitiveWordService.MinMatchTYpe);
        System.out.println(result);
 
        //获取语句中的敏感词
        Set<String> set = sensitiveWordService.getSensitiveWord(string);
        System.out.println("语句中包含敏感词的个数为：" + set.size() + "。包含：" + set);
        set = sensitiveWordService.getSensitiveWord(string, sensitiveWordService.MinMatchTYpe);
        System.out.println("语句中包含敏感词的个数为：" + set.size() + "。包含：" + set);
 
        //替换语句中的敏感词
        String filterStr = sensitiveWordService.replaceSensitiveWord(string, '*');
        System.out.println(filterStr);
        filterStr = sensitiveWordService.replaceSensitiveWord(string, '*', sensitiveWordService.MinMatchTYpe);
        System.out.println(filterStr);
 
        String filterStr2 = sensitiveWordService.replaceSensitiveWord(string, "[*敏感词*]");
        System.out.println(filterStr2);
        filterStr2 = sensitiveWordService.replaceSensitiveWord(string, "[*敏感词*]", sensitiveWordService.MinMatchTYpe);
        System.out.println(filterStr2);
    }
