...
/**
 * 任务验收付款成功后，更新会员相关统计数据
 */
@Service
public class XmTaskAcceptanceForPersonMessageListener extends QueueListener<Map<String,Object>> {
    ...
    public Object getQueueKey() {
        return "xm_task_acceptance_success_for_person";
    }

    @Override
    @Transactional
    public void handleMessage(Map<String, Object> userInterests) {
        logger.debug("=============更新用户完工后的能力等级=============");
        ...
        userGradeRecordService.addRecord(userid,"2",bizId,exp,at,"项目验收获得经验值");
