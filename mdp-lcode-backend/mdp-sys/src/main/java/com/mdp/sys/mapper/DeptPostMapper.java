...
public interface DeptPostMapper extends BaseMapper<DeptPost> {
    ...
    List<DeptPost> selectByDeptidAndPostIdList(List<DeptPost> deptPosts);

    List<Map<String, Object>> selectListDeptPostRoleByRoleids(Map<String, Object> p);

    List<Map<String, Object>> selectListMapByDeptids(String[] deptids);
}
