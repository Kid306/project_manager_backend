...
public interface DeptPostUserMapper extends BaseMapper<DeptPostUser> {
    ...
    List<Map<String, Object>> listDeptPostUserRoles(Map<String, Object> p);

    void setAllPostNotMaster(Map<String, Object> map);

    void setPostMaster(Map<String, Object> map);

    List<Map<String, Object>> listDeptPostUserMenus(Map<String, Object> deptPostUser);
}
