...
public interface UserFansMapper extends BaseMapper<UserFans> {
    ...
    List<Map<String, Object>> myFans(Map<String, Object> userFans);

    List<Map<String, Object>> myFocus(Map<String, Object> userFans);

    FansCpdVo fansCpd(Map<String, Object> userFans);
}
