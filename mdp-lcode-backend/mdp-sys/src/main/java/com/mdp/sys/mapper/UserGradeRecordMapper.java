...
public interface UserGradeRecordMapper extends BaseMapper<UserGradeRecord> {
    ...
    BigDecimal selectUserTotalExp(String userid);

    int updateByBizIdAndUserid(UserGradeRecord update);
}
