 ...
 */
@Data
@TableName("xm_collect_state_his")
@Schema(description="机构内所有项目指标汇总")
public class XmCollectStateHis  implements java.io.Serializable {
	...
	/**
	 *统计日期yyyy-mm-dd类型,集合编号
	 **/
	public XmCollectStateHis(String bizDate,String collectId) {
