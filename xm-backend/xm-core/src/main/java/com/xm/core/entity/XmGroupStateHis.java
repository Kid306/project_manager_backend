 ...
 */
@Data
@TableName("xm_group_state_his")
@Schema(description="项目指标日统计表")
public class XmGroupStateHis  implements java.io.Serializable {
	
	private static final long serialVersionUID = 1L;
    @TableIds
	
    @Schema(description="统计日期yyyy-mm-dd类型,主键")
    String bizDate;
    @TableIds
	
    @Schema(description="组编号,主键")
    String groupId;
	...
	/**
	 *统计日期yyyy-mm-dd类型,组编号
	 **/
	public XmGroupStateHis(String bizDate,String groupId) {
