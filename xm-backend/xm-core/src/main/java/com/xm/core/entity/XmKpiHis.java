 ...
 */
@Data
@TableName("xm_kpi_his")
@Schema(description="项目或任务关键指标考核")
public class XmKpiHis  implements java.io.Serializable {
	 ...
	 *主键,审核时间
	 **/
	public XmKpiHis(String id,Date kadmTime) {
		this.id = id;
		this.kadmTime = kadmTime;
	}
