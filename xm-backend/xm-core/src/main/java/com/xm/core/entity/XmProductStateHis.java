 ...
 */
@Data
@TableName("xm_product_state_his")
@Schema(description="项目指标日统计表")
public class XmProductStateHis  implements java.io.Serializable {
	...
	/**
	 *产品编号,统计日期yyyy-mm-dd类型
	 **/
	public XmProductStateHis(String productId,String bizDate) {
